                                            ...
                                            <tbody>
                                                <j:forEach items="${listaSolicitudes}" var="s">
                                                    <tr id="${s.getId_formulario()}">
                                                        ...
                                                        <td>
                                                            <a class="btn btn-datatable btn-icon btn-transparent-dark mr-2" href="../GetArchivo?id=${s.getId_formulario()}" data-toggle="tooltip" data-placement="top" data-original-title="Descargar Archivo">
                                                                <i data-feather="download"></i>
                                                            </a>
                                                            <button class="btn btn-datatable btn-icon btn-transparent-dark mr-2" onclick="editSolicitud(${s.getId_formulario()});" data-toggle="tooltip" data-placement="top" data-original-title="Editar Solicitud">
