...
@WebServlet(name = "addSolicitudAlumno", urlPatterns = {"/addSolicitudAlumno"},loadOnStartup = 1)
public class addSolicitudAlumno extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            annio_ingreso = Integer.parseInt(!request.getParameter("ingreso").equals("")?request.getParameter("ingreso"):"0");
            semestre = Integer.parseInt(!request.getParameter("semestre").equals("")?request.getParameter("semestre"):"0");
            anio_egreso = Integer.parseInt(!request.getParameter("anioegreso").equals("")?request.getParameter("anioegreso"):"0");
            r2_hermano = request.getParameter("rutSegundoHermano");
            r3_hermano = request.getParameter("rutTercerHermano");
            ...
            if(dSolicitud.agregar(sol)==1)
            {
                ...
                response.sendRedirect("alumno/solicitud.jsp");
            }
            else
            {
